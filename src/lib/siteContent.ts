...
export const CONTENT_KEYS = {
  ...
  HOME_BOLEIAS_TITLE_NEED: 'home.boleias.title_need',
  HOME_BOLEIAS_DESCRIPTION: 'home.boleias.description',
  HOME_BOLEIAS_DESCRIPTION_NEED: 'home.boleias.description_need',
  ...
  HOME_BOLEIAS_SEATS_LABEL_NEED: 'home.boleias.seats_label_need',
  ...
  HOME_BOLEIAS_SUCCESS_MESSAGE_NEED: 'home.boleias.success_message_need',
...
export const CONTENT_DEFAULTS: Record<ContentKey, ContentDefault> = {
  ...
  'home.hero.location_church': { value: 'Igreja de São Sebastião da Pedreira', type: 'text', label: 'Localização Igreja', section: 'Hero' },
  ...
  'home.venue.ceremony.name': { value: 'Igreja de São Sebastião da Pedreira', type: 'text', label: 'Nome da cerimónia', section: 'Cerimónia' },
  'home.venue.ceremony.address': { value: 'Igreja de São Sebastião da Pedreira, Lisboa', type: 'text', label: 'Morada da cerimónia', section: 'Cerimónia' },
  ...
  'home.venue.ceremony.gmaps': { value: 'https://www.google.com/maps/dir/?api=1&destination=Igreja+de+S%C3%A3o+Sebasti%C3%A3o+da+Pedreira,+Lisboa,+Portugal', type: 'url', label: 'Google Maps (cerimónia)', section: 'Cerimónia' },
  'home.venue.ceremony.apple': { value: 'https://maps.apple.com/?daddr=Igreja+de+S%C3%A3o+Sebasti%C3%A3o+da+Pedreira,+Lisboa,+Portugal', type: 'url', label: 'Apple Maps (cerimónia)', section: 'Cerimónia' },
  'home.venue.ceremony.waze': { value: 'https://waze.com/ul?q=Igreja+de+S%C3%A3o+Sebasti%C3%A3o+da+Pedreira+Lisboa+Portugal&navigate=yes', type: 'url', label: 'Waze (cerimónia)', section: 'Cerimónia' },
  ...
  'home.boleias.title': { value: 'Oferece boleia?', type: 'text', label: 'Título do modal boleias (oferta)', section: 'Modal Boleias' },
  'home.boleias.title_need': { value: 'Precisa de boleia?', type: 'text', label: 'Título do modal boleias (pedido)', section: 'Modal Boleias' },
  'home.boleias.description': { value: 'Registe a sua disponibilidade para ajudar outros convidados.', type: 'text', label: 'Descrição do modal boleias (oferta)', section: 'Modal Boleias' },
  'home.boleias.description_need': { value: 'Diga-nos de onde parte e tentamos ligá-lo a quem tem lugar disponível.', type: 'text', label: 'Descrição do modal boleias (pedido)', section: 'Modal Boleias' },
  ...
  'home.boleias.seats_label': { value: 'Lugares disponíveis *', type: 'text', label: 'Label lugares (oferta)', section: 'Modal Boleias' },
  'home.boleias.seats_label_need': { value: 'Quantos lugares precisa? *', type: 'text', label: 'Label lugares (pedido)', section: 'Modal Boleias' },
  ...
  'home.boleias.success_message': { value: 'Registámos a disponibilidade.', type: 'text', label: 'Mensagem de sucesso (oferta)', section: 'Modal Boleias' },
  'home.boleias.success_message_need': { value: 'Registámos o seu pedido de boleia.', type: 'text', label: 'Mensagem de sucesso (pedido)', section: 'Modal Boleias' },
