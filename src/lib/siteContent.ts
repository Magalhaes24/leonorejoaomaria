...
export const CONTENT_DEFAULTS: Record<ContentKey, ContentDefault> = {
  ...
  'home.list.title': { value: 'Contribui para o nosso novo capítulo.', type: 'text', label: 'Título da lista', section: 'Lista (teaser)' },
  'home.list.description': { value: 'Se quiseres contribuir para a nossa nova casa ou para a nossa lua de mel, preparámos uma pequena lista.', type: 'text', label: 'Descrição da lista', section: 'Lista (teaser)' },
  ...
  'home.allergies_modal.description': { value: 'Indica-nos se tens alguma alergia ou intolerância para que possamos preparar a ementa.', type: 'text', label: 'Descrição do modal alergias', section: 'Modal Alergias' },
  'home.allergies_modal.name_label': { value: 'O teu nome *', type: 'text', label: 'Label nome (alergias)', section: 'Modal Alergias' },
  ...
  'home.transport.description': { value: 'Se podes oferecer ou precisas de boleia para a cerimónia ou para o regresso, regista-te aqui. Vamos tentar ligar quem precisa de transporte a quem pode ajudar.', type: 'text', label: 'Descrição dos transportes', section: 'Transportes' },
  ...
  'home.allergies.description': { value: 'Para garantir que toda a gente desfruta da refeição com segurança, pedimos que nos indiques quaisquer alergias ou intolerâncias alimentares.', type: 'text', label: 'Descrição das alergias', section: 'Alergias' },
  ...
  'lista.honeymoon.message_label': { value: 'Deixa uma mensagem (opcional)', type: 'text', label: 'Label do campo mensagem', section: 'Lua de Mel' },
